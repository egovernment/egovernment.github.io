...
rate: '2'
number: '114'
introduction-text: 'Un registro puede ser obligatorio, opcional o inaplicable en cierta(s) situación(es). Ejemplo: el registro ante el Registro de Comercio es opcional para los activos inferiores a 12000 . Este determinante de nivel 1 se ve reflejado por una pregunta inicial en la guía.'
