...
All CSS rules are organized with small component files, which then are bundled into one CSS file per application. The [Prototype project](http://proto.eregistrations.org/) showcases most of the predefined and reusable view components.
...
All generic CSS modules are placed in [/css](https://github.com/egovernment/eregistrations/tree/master/css) folder of eRegistrations project.
...
It checks the code against most of [pre-configured rules](https://github.com/CSSLint/csslint/wiki/Rules) and some [white-space rules](https://github.com/medikoo/csslint-next#additional-rules) added by us.
...
Every eRegistrations system should have [CSS lint tasks](https://github.com/egovernment/eregistrations/blob/master/package.json#L37-L39) configured, and eventual CSS lint configuration added to `.lint` files.
...
Example can be found [here](https://github.com/egovernment/eregistrations/blob/master/view/components/business-process-main-info.js#L23-L30) 
...
Tooltips are small, black, pop-up windows that are displayed on hover over significant element. 
